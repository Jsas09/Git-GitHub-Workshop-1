...
const PARTNER_A = {
  name: "Jon Arcelay",
  major: "Computerized Information Systems",
  favoriteTech: "Intellisense",
  initials: "A",
};
...
const SKILLS = ["Your Communication skills", "Git", "GitHub", "HTML", "CSS", "JavaScript", "Python"];

// PARTNER A & B TASK: Add project ideas that the team might want to build together.
const PROJECT_IDEAS = [
  { icon: "?", title: "Second workshop regarding vscode", detail: "Another workshop with Alma." },
];
